    ...
    <section className="Resume-Section" id="resume">
      ...
      {!resumeFits && [
        ...
        <h4 style={{ color: "darkred" }}>
          (If possible, try rotating your device to landscape mode and reloading
          the page.)
        </h4>,
      ]}
      <p>
        You can also{" "}
        <a
          href="https://github.com/ConnorMooneyhan/ConnorMooneyhan.github.io/raw/main/src/resources/resume-mooneyhan.pdf"
          download
        >
          download my resume
        </a>{" "}
